...
//    private int countDownTime = 30* 1000;
...
/*
    ...
    private void loadBanner(){
        ...
        AdRequest adRequest = new AdRequest.Builder()
                ...
                .addTestDevice("580A41A9BF5044DA9BF02B1E0EDCBB44")          //Allview P5 Energy  Anca
...
//            int new_id_image = getResources().getIdentifier("city" + new Random().nextInt(3), "drawable", getPackageName());
            if (id_image != new_id_image) {
                SharedPreferences.Editor editor = prefs.edit();
                editor.putLong(lastBackgroundChangeKey, System.currentTimeMillis());
                editor.putInt(backImage_id_Key, new_id_image);
                editor.commit();
            }
        }
    ...
    private void initTimer() {
        mCountDownTimer = new CountDownTimer(countDownTime, countDownTime) {
            @Override
